...
- Tests: 639 frontend (57 suites) + 93 backend (10 suites) = 732 total
...
- i18n: `react-i18next` configured with en/es locales, imported in `App.tsx`. DashboardScreen, AnalyticsScreen, WalletsScreen use `useTranslation()`. Other screens still have hardcoded strings.
