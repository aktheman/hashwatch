  ...
  useMinerStore: Object.assign(
      ...
      }),
    {
      getState: () => ({
        ...
        loadGroupConfigs: () => Promise.resolve([]),
        saveGroupConfigs: () => Promise.resolve(),
        loadGroupAlerts: () => Promise.resolve([]),
        saveGroupAlerts: () => Promise.resolve(),
        evaluateGroupAlerts: () => Promise.resolve([]),
      }),
    },
  ),
}));
