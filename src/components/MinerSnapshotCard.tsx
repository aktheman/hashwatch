      ...
      >
        <View style={{ flexDirection: 'row' }}>
          <View style={{ flex: 1, alignItems: 'center' }}>
            <Text style={statLabel}>{t('snapshot.hashrate')}</Text>
            <Text
              style={{
                color: theme.primary,
                ...statValue,
          ...
          <View style={{ flex: 1, alignItems: 'center' }}>
            <Text style={statLabel}>{t('snapshot.temp')}</Text>
            <Text
              style={{
          ...
          <View style={{ width: 1, backgroundColor: theme.border }} />
          <View style={{ flex: 1, alignItems: 'center' }}>
            <Text style={statLabel}>{t('snapshot.uptime')}</Text>
